            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-hourglass aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Warehouses')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>

                    <!--Submenu For Warehouse-->
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{ route('warehouse.index') }}">
                                    <span class="aiz-side-nav-text">{{translate('Warehouse')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{ route('location.index') }}">
                                    <span class="aiz-side-nav-text">{{translate('Location')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{ route('area.index') }}">
                                    <span class="aiz-side-nav-text">{{translate('Area')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{ route('shelf.index') }}">
                                    <span class="aiz-side-nav-text">{{translate('Shelf')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{ route('cell.index') }}">
                                    <span class="aiz-side-nav-text">{{translate('Cell')}}</span>
                                </a>
                            </li>
                        </ul>
                    <!--End of Submenu For Warehouse-->
                    </li>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{ route('package.index') }}">
                                    <span class="aiz-side-nav-text">{{translate('Package List')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{ route('package-users.index') }}">
                                    <span class="aiz-side-nav-text">{{translate('Package Users')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <!-- Reports -->
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('transaction-history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['transaction-history.index'])}}">
