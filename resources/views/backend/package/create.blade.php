            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('package.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" min="0" class="form-control" name="package_price" placeholder="{{translate('Package Price')}}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="product_limit" placeholder="{{translate('Product upload limit')}}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="warehouse_limit" placeholder="{{translate('Warehouse limit')}}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="daraz_sync_limit" placeholder="{{translate('Daraz sync limit')}}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="package_duration" placeholder="{{translate('Package Duration')}}" required>
