...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('shelf.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
...
<script type="text/javascript">
    ...
    $('#btn_add_cell').on('click', function() {
        window.location.href = "{{ route('cell.create') }}";
    });
