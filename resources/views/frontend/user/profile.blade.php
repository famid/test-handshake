...
@section('panel_content')
    ...
    <form action="{{ route('daraz_setting.update') }}" method="POST">
        @csrf
        <div class="card">
          <div class="card-header">
              <h5 class="mb-0 h6">{{ translate('Daraz Intregation')}}</h5>
          </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2">
                      <label>{{ translate('Your App Key') }}</label>
                    </div>
                    <div class="col-md-10">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="{{ translate('Your App Key')}}" name="app_key" value="{{ $daraz_setting->app_key ?? '' }}" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                        <label>{{ translate('Your Secret Key') }}</label>
                    </div>
                    <div class="col-md-10">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="{{ translate('Your Secret Key')}}" name="secret_key" value="{{ $daraz_setting->secret_key ?? '' }}" />
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group mb-0 text-right">
