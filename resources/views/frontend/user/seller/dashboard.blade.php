                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            @if($customer_package != null)
                                ...
                                <p class="mb-1 text-muted">{{ translate('Product Upload') }}: {{ $customer_package->Package->product_limit }} {{ translate('Times')}}</p>
                                {{-- <p class="mb-1 text-muted">{{ translate('Daraz Upload') }}: {{ $customer_package->Package->daraz_sync_limit }} {{ translate('Times')}}</p> --}}
                                <p class="mb-1 text-muted">{{ translate('Waarehouse Limit') }}: {{ $customer_package->Package->warehouse_limit }} {{ translate('Times')}}</p>
                                <p class="text-muted mb-1">{{ translate('Product Upload Remaining') }}: {{ $customer_package->remain_product }} {{ translate('Times')}}</p>
                                <p class="text-muted mb-1">{{ translate('Warehouse Remaining') }}: {{ $customer_package->remain_warehouse }} {{ translate('Times')}}</p>
