                    ...
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
                              ...
                              <a class="btn btn-soft-secondary btn-icon btn-circle btn-sm" href="{{route('inventory.show', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')])}}" title="{{ translate('Manage Inventory') }}">
