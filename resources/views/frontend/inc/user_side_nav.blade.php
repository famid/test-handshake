<div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
        <div class="p-4 text-xl-center mb-2 border-bottom bg-primary text-white position-relative">
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                @if (loginType() == 'seller' && Auth::user()->has_multi_account == 0)
                    <li class="aiz-side-nav-item text-center mb-2">
                        <a href="{{ route('shops.create') }}" class="btn btn-primary">Become a Vendor</a>
                    </li>
                @elseif(loginType() == 'vendor' && Auth::user()->has_multi_account == 0)
                    <li class="aiz-side-nav-item text-center mb-2">
                        <a href="{{ route('become.seller') }}" class="btn btn-primary">Become a Seller</a>
                    </li>
                @endif

                @if (Auth::check() && Auth::user()->has_multi_account == 1)
                        @if (loginType() == 'vendor')
                            <li class="aiz-side-nav-item text-center mb-2">
                                <a href="{{ route('auth.switch') }}" class="btn btn-primary btn-sm shadow-md">
                                    {{ translate('Switch to seller') }}
                                </a>
                            </li>
                        @else
                            <li class="aiz-side-nav-item text-center mb-2">
                                <a href="{{ route('auth.switch') }}" class="btn btn-primary btn-sm shadow-md">
                                    {{ translate('Switch to vendor') }}
                                </a>
                            </li>
                        @endif
                    @endif
                ...
                @else
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller.warehouse.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Warehouse') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller.location.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Location') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller.area.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Area') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller.shelf.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Shelf') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller.cell.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Cell') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    <!-- End Vendor Warehouse Management -->
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('home') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('View Inventory') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('home') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Stock In') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    @if(addon_is_activated('auction'))
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if (loginType() == 'vendor' && get_setting('seller_auction_product') == 1)
                                    <li class="aiz-side-nav-item">
                ...
                @if(loginType() == 'seller')
                    ...
                    @if(activeShop() != null && activeShop()->status != 0)
                        <li class="aiz-side-nav-item">
                            <a href="{{route('disconnect.daraz')}}" class="aiz-side-nav-link">
                                <i class="las la-minus-circle aiz-side-nav-icon"></i>
                                <button id="daraz-activate" class="btn-success d-inline-block">
                                    <span class="aiz-side-nav-text">{{translate('Disconnect Daraz')}}</span>
                                </button>
                    ...
                    @else
                        <li class="aiz-side-nav-item">
                            <a href="https://api.daraz.com.bd/oauth/authorize?response_type=code&force_auth=true&redirect_uri=https://handshakebd.net/daraz-callback/&client_id=500812&state={{ activeShop()->slug ?? '' }}" class="aiz-side-nav-link {{ areActiveRoutes(['profile'])}}">
                                <i class="las la-plus-circle aiz-side-nav-icon"></i>
                                <button id="connect-to-daraz" class="btn-danger">
                                    <span class="aiz-side-nav-text">{{translate('Connect To Daraz')}}</span>
                                </button>
