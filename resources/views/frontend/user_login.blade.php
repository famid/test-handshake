                        ...
                        <div class="card">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                ...
                                <div class="text-center">
                                    @if ($vendor_login)
                                        <a href="{{ route('user.login') }}">{{ translate('Login as Seller')}}</a>
                                    @else
                                        <a href="{{ route('vendor.login') }}">{{ translate('Login as Vendor')}}</a>
                                    @endif
                                    <p class="text-muted mb-0">{{ translate('Dont have an account?')}}</p>
                                    @if ($vendor_login)
                                        <a href="{{ route('shops.create') }}">{{ translate('Register Now')}}</a>
                                    @else
