...
@section('panel_content')
    ...
    <div class="">
        <form class="form form-horizontal mar-top" action="{{route('seller.area.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('#btn_add_shelf').on('click', function() {
            window.location.href = "{{ route('seller.shelf.create') }}";
        });
