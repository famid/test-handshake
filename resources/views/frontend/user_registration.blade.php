                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            <div class="text-center pt-4">
                                <h1 class="h4 fw-600">
                                    {{ translate('Create seller account.')}}
                                </h1>
                            </div>
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>{{ translate('Nid Front')}} <span class="text-primary">*</span></label>
                                            <input type="file" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{  translate('Password') }}" name="nid_front" accept="image/png, image/jpeg" required>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ translate('Nid Back')}} <span class="text-primary">*</span></label>
                                            <input type="file" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{  translate('Password') }}" name="nid_back" accept="image/png, image/jpeg" required>
                                        </div>
                                ...
                                <div class="text-center">
                                    <a href="{{ route('shops.create') }}">{{ translate('Register as vendor')}}</a>
