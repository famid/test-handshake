...
// Check Login Type User
if (!function_exists('loginType')) {
    function loginType()
    {
...
if (!function_exists('checkPackage')) {
    ...
    {
        $package = PackageUser::where('user_id',Auth::user()->id)->where('user_type',loginType())->first();
        if ($package) {
            return $package;
        }
...
if (!function_exists('countDays')) {
    function countDays($current_date,$end_date)
    {
...
// Current Active Daraz Shop

if (!function_exists('activeShop')) {
    function activeShop()
    {
        $shop = DarazShop::find(session()->get('daraz_active_shop'));
...
//     function packageSubscription($package_id,$user_id)
//     {
//         $package_user = PackageUser::where('package_id',$package_id)->where('user_id',$user_id)->first();

//         if ($package_user) {

//             if ($package_user->subscription_end != null) {
//                 $subscription = $package_user->subscription_end - $package_user->subscription_start;
//             }
//         }
//     }
// }
