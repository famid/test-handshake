...
class ShopController extends Controller
{
    ...
    public function create()
    {
        if(Auth::check() && Auth::user()->user_type == 'admin'){
            ...
            flash(translate('You already have a vendor account!'))->error();
            return back();
        }
        else{
    ...
    public function store(Request $request)
    {
        ...
        if(!Auth::check()){
            ...
            if($request->password == $request->password_confirmation){
                ...
                $user->user_type = "seller"; /* This seller equals to vendor */
                $user->password = Hash::make($request->password);
                $user->save();

                $this->upload_file($request->nid_front, $user, 'nid_front', 'uploads/all');
                $this->upload_file($request->nid_back,  $user, 'nid_back', 'uploads/all');
                $this->GenerateSlug('url_slug', $user, $request->name);
            }
            else{
