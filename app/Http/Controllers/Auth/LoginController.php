    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        if ($check_user != null) {
            ...
            if ($check_user->has_multi_account == 0 && $check_user->user_type == 'customer' && $request->user_type == 'vendor') {

                flash(translate('Invalid login credentials'))->error();
                return redirect()->route('user.login');

            }elseif ($check_user->has_multi_account == 0 && $check_user->user_type == 'seller' && $request->user_type == 'seller') {
    ...
    protected function credentials(Request $request)
    {
        ...
        if ($request->get('phone') != null) {
            ...
            if ($request->user_type != null) {
                ...
                Session::put('login_as',$request->user_type);
            }else{

                if ($check_user->has_multi_account == 1 && $check_user->user_type == 'seller') {
                    Session::put('login_as','vendor');
                }elseif ($check_user->has_multi_account == 0 && $check_user->user_type == 'seller') {
                    Session::put('login_as','vendor');
                }elseif ($check_user->has_multi_account == 0 && $check_user->user_type == 'customer') {
