...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::patch('/warehouse/update/{id}', 'WarehouseController@update')->name('warehouse.update');
    ...
    //shelf
    Route::get('/shelf', 'ShelfController@index')->name('shelf.index');
    Route::get('/shelf/destroy/{id}', 'ShelfController@destroy')->name('shelf.destroy');

    //cell
    Route::get('/cell', 'CellController@index')->name('cell.index');
    ...
    Route::get('/transactions','ReportController@allTransaction')->name('transaction-history.index');
    Route::get('/transactions/{id}','ReportController@showTransaction')->name('transaction-history.show');
    ...
    Route::resource('package-users','PackageUserController');
    Route::get('/user-wise-package/{id}','PackageUserController@packageByUser')->name('package_by_user');
